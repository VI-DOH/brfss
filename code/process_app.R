  ...
  shinyApp(
    ...
    server = function(input, output, session = session){
      ...
      observeEvent(input$select_all_id,{
        ...
        updateSwitchInput(session = session, "attribs_id", value = tf)
      ...
      observeEvent(procChanged(), {
        ...
        proc_state <- all(input$layout_id, input$convert_id, input$factorize_id,
                          ...
                          input$split_id, input$attribs_id, input$codebook_id,
                          input$response_id)
      ...
      observeEvent(input$process_id, {
        ...
        if(!rvals$proc_changed ) {
          ...
          updateMaterialSwitch(session = session, "attribt_id", value = input$process_id)
      ...
      observeEvent(input$geog_id, {
        ...
        cat("observing geog_id",input$geog_id,"\n")
        ...
        cat(" leaving observeEvent(input$other_downloads_id ... " , input$other_downloads_id, "\n")
      ...
      observeEvent(input$other_downloads_id, {
        ...
        cat(" observeEvent(input$other_downloads_id ... " , input$other_downloads_id, "\n")
